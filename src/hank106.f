...
ccc        entry hank106b(r,h0,h1,w,ijw)
        subroutine hank106b(r,h0,h1,w,ijw,ninterv)
        implicit real *8(a-h,o-z)
        complex *16 h0,h1
        integer ijw(4)
        real *8 w(*)
c
        ...
        call hank106eva(r,w(1),11,w(21),w(41+6*ninterv),
     1      w(25+2*ninterv),w(33+4*ninterv),h0,h1,w(2),
     2      w(49+28*ninterv),
     2      w(3),w(6),ninterv)
c
        return
...
ccc           call hank106a(r,h0,h1,w(istart(i)))
           call hank106b(r,h0,h1,w(istart(i)),w(istart(i)+10),
     1        nintervec(i))
